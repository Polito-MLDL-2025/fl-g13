...
#     f"{CHECKPOINT_DIR}/BaseDino/togekiss-nn_BaseDino_epoch_x.pth",
...
# )
# model.to(device)
# loaded_metrics = load_loss_and_accuracies(path=f"{CHECKPOINT_DIR}/BaseDino/togekiss-nn_BaseDino_epoch_x.loss_acc.json")
