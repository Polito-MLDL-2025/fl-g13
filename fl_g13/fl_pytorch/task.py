...
def train(net, trainloader, epochs,criterion=None,optimizer=None, lr=1e-4, weight_decay=0.04,momentum=0.9, device=None):
...
def test(net, testloader,criterion, device=None):
